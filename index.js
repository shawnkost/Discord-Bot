...
const sadWords = ["sad", "depressed", "unhappy", "angry", "miserable", "upset", "anxious"]
...
client.on("message", async msg => {
  ...
  if (msg.content.includes("demon slayer movie")) {
    const attachment = new Discord.MessageAttachment('https://memegenerator.net/img/instances/65073182.jpg');
